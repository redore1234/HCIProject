...
class DetailClinicScreen extends StatefulWidget{
  ...
  DetailClinicScreen(Clinic clinic) :
      clinic = clinic, super(key : new ObjectKey(clinic));
  @override
...
class ListRating extends StatefulWidget{
  final Rating rating;
  ListRating(Rating rating): rating = rating, super(key: new ObjectKey(rating));
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      leading: GestureDetector(
        child: CircleAvatar(child: Image.asset(Constants.IMAGE_FOLDER_REF + rating.image),),
      ),
      title: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
